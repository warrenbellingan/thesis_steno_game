...
class MultiplayerStrokeHostView
              ...
              if (viewModel.gameStatus == 3)
                Column(
                  children: [
                    ...
                    verticalSpaceSmall,
                    Text(
                      viewModel.game.type == "stroke" ? "Received: ${viewModel.sText.length}/${viewModel.students.length}" : "Received: ${viewModel.sStroke.length}/${viewModel.students.length}",
  ...
  @override
  MultiplayerStrokeHostViewModel viewModelBuilder(BuildContext context,) =>
